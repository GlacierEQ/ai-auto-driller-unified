// ==UserScript==
// @name         Grok Auto-Driller Unified — MAX Edition
...
(function() {
    ...
    const SEL = {
        ...
        response: ['[class*="message"]','[class*="response"]','.markdown'],
        loading: ['[class*="loading"]','[class*="generating"]']
    };
    const log = (...a) => { if (CONFIG.debug) console.log('[Grok-MAX]', ...a); };

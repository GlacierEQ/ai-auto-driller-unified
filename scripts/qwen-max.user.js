// ==UserScript==
// @name         Qwen Auto-Driller Unified — MAX Edition
...
(function() {
    ...
    const SEL = {
        ...
        response: ['[class*="message"]','[class*="response"]','.markdown','[class*="answer"]'],
        loading: ['[class*="loading"]','[class*="generating"]','[class*="typing"]','[aria-busy="true"]']
    };
    const log = (...a) => { if (CONFIG.debug) console.log('[QWEN-MAX]', ...a); };

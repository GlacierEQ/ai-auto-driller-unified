// ==UserScript==
// @name         DeepSeek Auto-Driller Unified — MAX Edition
...
(function() {
    ...
    const SEL = {
        approve: ['button:has-text("Allow")','button:has-text("Accept")'],
        input: ['textarea','div[contenteditable="true"]'],
        submit: ['button[class*="send"]','button:has(svg)'],
        response: ['[class*="markdown"]','[class*="response"]','.prose'],
        loading: ['[class*="loading"]','[class*="generating"]','ds-loading']
    };
    const log = (...a) => { if (CONFIG.debug) console.log('[DeepSeek-MAX]', ...a); };

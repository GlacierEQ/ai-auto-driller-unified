// ==UserScript==
// @name         Claude Auto-Driller Unified — MAX Edition
...
(function() {
    ...
    const SEL = {
        ...
        response: ['.markdown','.prose','[class*="response"]'],
        loading: ['[class*="generating"]','[class*="loading"]']
    };
    const log = (...a) => { if (CONFIG.debug) console.log('[Claude-MAX]', ...a); };
